...
export type SessionWhereInput = {
  ...
  pid?: Prisma.IntFilter<"Session"> | number
  content_id?: Prisma.StringFilter<"Session"> | string
}
...
export type SessionScalarWhereWithAggregatesInput = {
  ...
  pid?: Prisma.IntWithAggregatesFilter<"Session"> | number
  content_id?: Prisma.StringWithAggregatesFilter<"Session"> | string
}
...
export type SessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"pid" | "content_id", ExtArgs["result"]["session"]>
...
export interface SessionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `pid`
   * const sessionWithPidOnly = await prisma.session.findMany({ select: { pid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Sessions and only return the `pid`
   * const sessionWithPidOnly = await prisma.session.createManyAndReturn({
   *   select: { pid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Sessions and only return the `pid`
   * const sessionWithPidOnly = await prisma.session.updateManyAndReturn({
   *   select: { pid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SessionFieldRefs {
  readonly pid: Prisma.FieldRef<"Session", 'Int'>
  readonly content_id: Prisma.FieldRef<"Session", 'String'>
}
